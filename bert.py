...
from cross_processor import appreview_processors as processors
from cross_processor import appreview_output_modes as output_modes
from sklearn.metrics import precision_recall_fscore_support
from sklearn.metrics import classification_report
from sklearn import metrics
#from change_lossfuc_modeling_bert import BertForSequenceClassification
try:
...
def basic_metrics(y_true, y_pred):
    return {'Accuracy': metrics.accuracy_score(y_true, y_pred),
            ...
            #'Micro-pre':metrics.precision_score(y_true,y_pred,average='micro'),
            #'Micro-recall': metrics.recall_score(y_true,y_pred,average='micro'),
            'Recall': metrics.recall_score(y_true, y_pred, average='macro'),
            'Macro-F1': metrics.f1_score(y_true, y_pred, average='macro'),
            #'Micro-F1': metrics.f1_score(y_true, y_pred, average='micro'),
            #'ALL':precision_recall_fscore_support(y_true,y_pred,average='micro'),
            #'y_true':y_true,
            #'y_pred':y_pred,
...
def main():
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            tokenizer = tokenizer.from_pretrained(checkpoint,do_lower_case=args.do_lower_case)
            model.to(args.device)
